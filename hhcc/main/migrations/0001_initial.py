# Generated by Django 5.0.7 on 2024-08-24 00:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('enfermedad', 'Enfermedad'), ('intervencion', 'Intervención'), ('otro', 'Otro')], default='otro', max_length=50)),
        ...
        migrations.AddField(
            ...
            name='paciente',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='main.paciente'),
        ),
        migrations.AddField(
            model_name='paciente',
            name='idtipodoc',
